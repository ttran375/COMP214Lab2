...
CREATE TABLE
  Customers (
    ...
    CONSTRAINT customers_region_ck CHECK (
...
CREATE TABLE
  acctmanager (
    ...
    CONSTRAINT acctmanager_region_ck CHECK (
      region IN ('N', 'NW', 'NE', 'S', 'SE', 'SW', 'W', 'E')
    )
  );
