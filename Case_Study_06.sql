...
ACCEPT crime_id CHAR DEFAULT 25344031 PROMPT 'Enter Crime_ID [Default: 25344031]: '

ACCEPT filing_date CHAR DEFAULT '02 13 2009' PROMPT 'Enter Filing_Date (MM DD YYYY) [Default: 02 13 2009]: '

ACCEPT hearing_date CHAR DEFAULT '02 27 2009' PROMPT 'Enter Hearing_Date (MM DD YYYY) [Default: 02 27 2009]: '

-- Declare variables to store user input
DECLARE
  V_CRIME_ID     NUMBER := &CRIME_ID;
  V_FILING_DATE  DATE := TO_DATE('&filing_date', 'MM DD YYYY');
  V_HEARING_DATE DATE := TO_DATE('&hearing_date', 'MM DD YYYY');
BEGIN
 -- Insert statement using substitution variables
  INSERT INTO APPEALS (
    APPEAL_ID,
    CRIME_ID,
    FILING_DATE,
